...
/*
 * Ceci est une copie adaptee
 * URL d'origine: http://grepcode.com/file/repo1.maven.org/maven2/org.mybatis/mybatis/3.0.4/org/apache/ibatis/jdbc/ScriptRunner.java
 *
 *Utilisation:
 *
...
public class ScriptRunner {
  ...
  private void executeFullScript(Reader reader) {
    ...
    try {
      ...
      throw new RuntimeException(message, e);//throw new RuntimeSqlException(message, e);
    }
  }
